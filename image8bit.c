...
Image ImageCreate(int width, int height, uint8 maxval) { ///
  ...
  img->pixel = calloc(width * height,  sizeof(uint8)); // calloc to initializes the allocated memory to zero (black)
...
// Nota: a versão 1 do ImageBlur() encontra-se no image8bitTest.c
